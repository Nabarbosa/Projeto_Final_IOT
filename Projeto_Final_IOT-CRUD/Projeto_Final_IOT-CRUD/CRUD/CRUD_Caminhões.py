...
# def verificar_id_existente(id_caminhao):
#     try:
...
# # CREATE - Criar
# def create_caminhao(id_caminhao, renavan, modelo, marca, cor, placa, chassi, status, tipo, peso):
#     # Adiciona o caminhão ao arquivo
...
#             if verificar_id_existente(id_caminhao):
#                 print(f"Erro: Já existe um caminhão cadastrado com o ID {id_caminhao}.")
#                 continue
...
#             tipo = input("Tipo: ")
#             peso = input("Peso: ")
#             create_caminhao(id_caminhao, renavan, modelo, marca, cor, placa, chassi, status, tipo, peso)
#         elif opcao == "2":
